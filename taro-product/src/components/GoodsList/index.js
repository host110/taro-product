                ...
                <View key={index} className="goods-li" data-id={item.id} onClick={ this.gotoDetail }>
                  <View className="pos">
                    <View className="Image-container">
                      <Image src={item.image ? `${item.image}!w750` : 'http://static-r.msparis.com/uploads/d/1/d1ca37e902e5550ad2c82c721bc216ce.png'} alt="" />
                    </View>
                    {
                  ...
                  <Text className="dark">{item.subtitle}</Text>
